...
#D_conductivity=2 * np.pi * f *imag_epsilon / (real_epsilon*8.85e-12)
...
#nearfield = sim.add_near2far(f, 0, 1,
 #       mp.Near2FarRegion(mp.Vector3(y=-sy/2), size=mp.Vector3(sx), weight=-1),
  #      mp.Near2FarRegion(mp.Vector3(-sx/2, 100-sy/2), size=mp.Vector3(y=200), weight=-1),
   #     mp.Near2FarRegion(mp.Vector3(sx/2, 100-sy/2), size=mp.Vector3(y=200), weight=1),
    #    mp.Near2FarRegion(mp.Vector3(y=200-sy/2), size=mp.Vector3(sx), weight=1))

#nearfield = sim.add_near2far(f, 0, 1,
 #       mp.Near2FarRegion(mp.Vector3(y=-sy/2), size=mp.Vector3(sx), weight=-1),
  #      mp.Near2FarRegion(mp.Vector3(sx/2, 100-sy/2), size=mp.Vector3(200), weight=1),
   #     mp.Near2FarRegion(mp.Vector3(-sx/2, 100-sy/2), size=mp.Vector3(200), weight=-1),
    #    mp.Near2FarRegion(mp.Vector3(, 200-sy/2), size=mp.Vector3(), weight=-1))
